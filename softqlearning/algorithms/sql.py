...
class SQL(RLAlgorithm):
    ...
    def __init__(
        ...
        self._observation_dim = self._env_spec.observation_space.flat_dim
    ...
    def _create_svgd_update(self):
        ...
        # to evaluate the expectation indexed by `i` and `updated_actions`
        # the expectation indexed by `j`.
